...
$pageHeader = __('dashboard.Categories');
      ...
      @else
        <table class="table table-hover">
          ...
          @foreach($data as $item)
            <tr>
              <td>{{ $item->name }}</td>
               <td>
                ...
                @else
                  <a href="#" data-toggle="modal" data-target="#img_modal_{{$item->id}}" title="icon">
                    <i class="fa fa-fw fa-image"> </i>
                  </a>
                @endif
              </td>
            ...
            @include('dashboard.components.imageModal', ['id' => $item->id,'img' => $item->icon])
          @endforeach
